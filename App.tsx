...
import srmLogo from './src/assets/srm-logo.png';
import vecLogo from './src/assets/vec-logo.png';
        ...
        <div className="relative h-full flex flex-col justify-between text-center px-4 md:px-6">
          ...
          <div className="relative z-20 pt-20 md:pt-24">
            <div className="inline-flex items-center justify-center gap-4 md:gap-8 px-6 md:px-10 py-3 md:py-4 backdrop-blur-xl bg-black/40 rounded-2xl md:rounded-3xl border border-white/10 shadow-2xl">
              <img src={srmLogo} alt="SRM Logo" className="h-10 md:h-14 lg:h-16 object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]" />
              ...
              <img src={vecLogo} alt="VEC Logo" className="h-10 md:h-14 lg:h-16 object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]" />
            </div>
          </div>
